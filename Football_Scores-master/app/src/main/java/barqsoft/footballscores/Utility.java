...
//            return String.format(Locale.getDefault(), context.getString(R.string.match_score_description), 0, 0);
    ...
    public static int getTeamCrestByTeamName (String teamName)
    {
        ...
        {   //This is the set of icons that are currently in the app.
            ...
            // Budnesliga
            case "FC Bayern M�nchen" : return R.drawable.bayern_munchen;
            ...
            case "Bor. M�nchengladbach" : return R.drawable.borussia_munchengladbach;
            ...
            case "1. FC K�ln" : return R.drawable.fc_koln;
            ...
            case "Fortuna D�sseldorf" : return R.drawable.fortuna_dusseldorf;
            case "FC St. Pauli" : return R.drawable.fc_st_pauli;
            // La Ligua
            case "FC Barcelona" : return R.drawable.barcelona;
            case "Club Atl�tico de Madrid" : return R.drawable.atletico_madrid;
