...
public class myFetchService extends IntentService {
    // number of days before and after today to fetch data:
    ...
    protected void onHandleIntent(Intent intent) {
        getData(String.format(getString(R.string.api_next_request), NUM_DAYS));
        getData(String.format(getString(R.string.api_previous_request), NUM_DAYS));
    }
...
//                        League.equals(PRIMERA_DIVISION)     )
                if (leagueCodes.contains(League)) {
